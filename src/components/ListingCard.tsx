...
export function ListingCard({ listing }: { listing: ListingWithRelations }) {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="p-5">
        <h3 className="text-lg font-semibold text-stone-900 transition-colors group-hover:text-red-600 dark:text-stone-100 dark:group-hover:text-red-400">
          {listing.name}
        </h3>

        <p className="mt-1 flex items-center gap-1.5 text-sm text-stone-500 dark:text-stone-400">
          <svg className="h-3.5 w-3.5 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
