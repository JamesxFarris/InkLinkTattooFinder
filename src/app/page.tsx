...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero — clean, fast, search-focused */}
      <section className="border-b border-stone-200/60 bg-white px-4 pb-16 pt-12 dark:border-stone-800/40 dark:bg-stone-950 sm:pb-20 sm:pt-16">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-4xl font-bold tracking-tight text-stone-900 dark:text-stone-100 sm:text-5xl">
            Find the Best{" "}
            <span className="text-red-600 dark:text-red-500">Tattoo Artists</span>{" "}
            Near You
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-stone-500 dark:text-stone-400">
          ...
          {/* Trust indicators */}
          <div className="mx-auto mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-stone-400 dark:text-stone-500">
            ...
            <span className="flex items-center gap-1.5">
              <svg className="h-4 w-4 text-sky-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
          ...
          <div className="mx-auto mt-6 flex flex-wrap items-center justify-center gap-2">
            ...
            {[
              ...
              <Link
                key={style.href}
                href={style.href}
                className="rounded-full bg-stone-100 px-3 py-1 text-xs font-medium text-stone-600 transition-colors hover:bg-red-50 hover:text-red-600 dark:bg-stone-800 dark:text-stone-400 dark:hover:bg-red-950 dark:hover:text-red-400"
              >
                {style.label}
              </Link>
            ))}
