...
async function main() {
  ...
  const categories = [
    ...
    { name: "Color Specialist", slug: "color-specialist", description: "Artists known for vibrant, lasting color work", type: "artist" as ListingType, icon: "🌈", sortOrder: 21 },
    { name: "Black & Grey", slug: "black-and-grey", description: "Artists specializing in grayscale shading work", type: "artist" as ListingType, icon: "🖤", sortOrder: 22 },
    { name: "Custom Design", slug: "custom-design", description: "Artists who create unique custom pieces for each client", type: "artist" as ListingType, icon: "💡", sortOrder: 23 },
    { name: "Flash Tattoos", slug: "flash-tattoos", description: "Pre-designed tattoo art available for walk-ins", type: "artist" as ListingType, icon: "⚡", sortOrder: 24 },
    // Supplier categories
    { name: "Tattoo Supplies", slug: "tattoo-supplies", description: "Equipment, ink, needles, and machines", type: "supplier" as ListingType, icon: "🛒", sortOrder: 25 },
    { name: "Aftercare Products", slug: "aftercare-products", description: "Healing balms, lotions, and tattoo care products", type: "supplier" as ListingType, icon: "💊", sortOrder: 26 },
    { name: "Tattoo Removal", slug: "tattoo-removal", description: "Laser removal and fading services", type: "supplier" as ListingType, icon: "❌", sortOrder: 27 },
    { name: "Piercing Studio", slug: "piercing-studio", description: "Body piercing services and jewelry", type: "supplier" as ListingType, icon: "💎", sortOrder: 28 },
  ];
  ...
  const listings = [
    ...
    { name: "Shamrock Social Club", slug: "shamrock-social-club-la", city: "los-angeles-CA", type: "shop" as ListingType, categories: ["traditional", "chicano", "black-and-grey"], description: "Hollywood institution for classic American traditional and Chicano-style tattoos.", phone: "3235552345", address: "9026 Sunset Blvd", zipCode: "90069", priceRange: "premium" as PriceRange, acceptsWalkIns: true, googleRating: 4.6, googleReviewCount: 891, featured: false, hours: { mon: "12-9", tue: "12-9", wed: "12-9", thu: "12-9", fri: "12-10", sat: "11-10", sun: "12-7" } },
    ...
    { name: "Guru Tattoo", slug: "guru-tattoo-san-diego", city: "san-diego-CA", type: "shop" as ListingType, categories: ["realism", "portrait", "color-specialist"], description: "World-renowned San Diego studio famous for photorealistic portraits and color work.", phone: "6195551234", address: "3431 Adams Ave", zipCode: "92116", priceRange: "luxury" as PriceRange, acceptsWalkIns: false, googleRating: 4.9, googleReviewCount: 334, featured: true, hours: { mon: "12-7", tue: "12-7", wed: "12-7", thu: "12-7", fri: "12-8", sat: "11-8", sun: "closed" } },
    ...
    { name: "Atomic Tattoo", slug: "atomic-tattoo-austin", city: "austin-TX", type: "shop" as ListingType, categories: ["new-school", "watercolor", "custom-design"], description: "Austin's most creative studio. Known for bold, colorful custom designs.", phone: "5125551234", address: "6601 S Lamar Blvd", zipCode: "78745", priceRange: "moderate" as PriceRange, acceptsWalkIns: true, piercingServices: true, googleRating: 4.6, googleReviewCount: 487, featured: false, hours: { mon: "11-9", tue: "11-9", wed: "11-9", thu: "11-9", fri: "11-10", sat: "10-10", sun: "12-8" } },
    ...
    { name: "Music City Ink", slug: "music-city-ink-nashville", city: "nashville-TN", type: "shop" as ListingType, categories: ["script-lettering", "fine-line", "custom-design"], description: "Nashville's favorite tattoo spot. Beautiful script work and custom designs inspired by music.", phone: "6155551234", address: "1713 Church St", zipCode: "37203", priceRange: "moderate" as PriceRange, acceptsWalkIns: true, googleRating: 4.7, googleReviewCount: 334, featured: false, hours: { mon: "11-8", tue: "11-8", wed: "11-8", thu: "11-8", fri: "11-9", sat: "10-9", sun: "12-6" } },
    ...
    { name: "Neon Dragon Tattoo", slug: "neon-dragon-tattoo-vegas", city: "las-vegas-NV", type: "shop" as ListingType, categories: ["japanese", "realism", "color-specialist"], description: "Las Vegas strip-adjacent studio. Famous for vibrant Japanese work and celebrity clientele.", phone: "7025551234", address: "3655 Las Vegas Blvd", zipCode: "89109", priceRange: "luxury" as PriceRange, acceptsWalkIns: true, piercingServices: true, googleRating: 4.7, googleReviewCount: 723, featured: true, hours: { mon: "10-12", tue: "10-12", wed: "10-12", thu: "10-12", fri: "10-2", sat: "10-2", sun: "10-10" } },
    { name: "Peachtree Ink", slug: "peachtree-ink-atlanta", city: "atlanta-GA", type: "shop" as ListingType, categories: ["realism", "portrait", "black-and-grey"], description: "Atlanta's top-rated portrait studio. Specializing in photorealistic black and grey work.", phone: "4045551234", address: "694 North Highland Ave", zipCode: "30306", priceRange: "premium" as PriceRange, acceptsWalkIns: false, googleRating: 4.8, googleReviewCount: 312, featured: false, hours: { mon: "12-8", tue: "12-8", wed: "12-8", thu: "12-8", fri: "12-9", sat: "11-9", sun: "closed" } },
    ...
    { name: "Midnight Sun Tattoo", slug: "midnight-sun-tattoo-anchorage", city: "anchorage-AK", type: "shop" as ListingType, categories: ["traditional", "blackwork", "custom-design"], description: "Alaska's finest tattoo studio. Custom work inspired by the Last Frontier.", phone: "9075551234", address: "425 W 5th Ave", zipCode: "99501", priceRange: "moderate" as PriceRange, acceptsWalkIns: true, googleRating: 4.6, googleReviewCount: 178, featured: false, hours: { mon: "12-8", tue: "12-8", wed: "12-8", thu: "12-8", fri: "12-9", sat: "11-9", sun: "closed" } },
    ...
    { name: "Bay Area Tattoo Collective", slug: "bay-area-tattoo-collective", city: "oakland-CA", type: "shop" as ListingType, categories: ["illustrative", "neo-traditional", "custom-design"], description: "Oakland artist collective. Multiple award-winning tattooers under one roof.", phone: "5105551234", address: "4301 Telegraph Ave", zipCode: "94609", priceRange: "premium" as PriceRange, acceptsWalkIns: false, googleRating: 4.8, googleReviewCount: 289, featured: false, hours: { mon: "12-8", tue: "12-8", wed: "12-8", thu: "12-8", fri: "12-9", sat: "11-9", sun: "closed" } },
    { name: "Riverfront Tattoo", slug: "riverfront-tattoo-memphis", city: "memphis-TN", type: "shop" as ListingType, categories: ["traditional", "script-lettering", "black-and-grey"], description: "Memphis studio on Beale Street. Music-inspired tattoos and classic American style.", phone: "9015551234", address: "333 Beale St", zipCode: "38103", priceRange: "budget" as PriceRange, acceptsWalkIns: true, piercingServices: true, googleRating: 4.3, googleReviewCount: 412, featured: false, hours: { mon: "11-9", tue: "11-9", wed: "11-9", thu: "11-9", fri: "11-11", sat: "10-11", sun: "12-8" } },
    ...
    { name: "Sunshine State Tattoo", slug: "sunshine-state-tattoo-miami", city: "miami-FL", type: "shop" as ListingType, categories: ["watercolor", "fine-line", "color-specialist"], description: "Miami Beach studio. Vibrant tropical-inspired watercolor and fine line tattoos.", phone: "3055551234", address: "1437 Washington Ave", zipCode: "33139", priceRange: "premium" as PriceRange, acceptsWalkIns: true, googleRating: 4.7, googleReviewCount: 445, featured: true, hours: { mon: "11-9", tue: "11-9", wed: "11-9", thu: "11-9", fri: "11-10", sat: "10-10", sun: "12-8" } },
    ...
    { name: "Northside Tattoo", slug: "northside-tattoo-columbus", city: "columbus-OH", type: "shop" as ListingType, categories: ["neo-traditional", "illustrative", "custom-design"], description: "Columbus studio in the Short North Arts District. Creative custom tattoo art.", phone: "6145551234", address: "732 N High St", zipCode: "43215", priceRange: "moderate" as PriceRange, acceptsWalkIns: true, googleRating: 4.6, googleReviewCount: 312, featured: false, hours: { mon: "11-8", tue: "11-8", wed: "11-8", thu: "11-8", fri: "11-9", sat: "10-9", sun: "12-6" } },
    ...
    { name: "Bluegrass Ink", slug: "bluegrass-ink-lexington", city: "lexington-KY", type: "shop" as ListingType, categories: ["traditional", "watercolor", "custom-design"], description: "Lexington's artistic tattoo parlor. Custom work inspired by Kentucky's natural beauty.", phone: "8595551234", address: "346 E Main St", zipCode: "40507", priceRange: "moderate" as PriceRange, acceptsWalkIns: true, googleRating: 4.6, googleReviewCount: 167, featured: false, hours: { mon: "11-8", tue: "11-8", wed: "11-8", thu: "11-8", fri: "11-9", sat: "10-9", sun: "12-6" } },
  ];
